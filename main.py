...
datapath = '/home/est_posgrado_manuel.suarez/data/dogs-vs-cats/train'
train_dogs_files = glob(os.path.join(datapath, 'dog.*.jpg'))
train_cats_files = glob(os.path.join(datapath, 'cat.*.jpg'))
...
display_images("figura_1.png", dogs_imgs, cats_imgs, rows=3)
